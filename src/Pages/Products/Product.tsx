        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          {/* <div className="mx-auto max-w-md shrink-0 lg:max-w-lg">
            ...
            <div className="mt-5 flex justify-center gap-5">
              <div className="flex size-24 cursor-pointer items-center rounded-md border border-blue-500 p-2">
                <img
                  className="hidden w-full dark:block"
                  src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg"
                  alt=""
              ...
              <div className="flex size-24 cursor-pointer items-center rounded-md p-2">
                <img
                  className="hidden w-full dark:block"
                  src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg"
                  alt=""
