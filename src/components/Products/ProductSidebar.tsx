      ...
      >
        ...
        <div className="flex flex-1 flex-col justify-between">
          ...
          <div className="mt-5 flex gap-5">
            <button
              type="submit"
              className="w-full rounded-lg bg-primary-700 px-5  text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-700 dark:hover:bg-primary-800 dark:focus:ring-primary-800"
            >
              Apply
            </button>
            <button
